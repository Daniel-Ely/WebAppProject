...
namespace WebApplicationProject_sucks.Controllers
{
    public class PostsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PostID,Title,Date,Rating,NumOfRating,PageID")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PostID,Title,Date,Rating,NumOfRating,PageID")] Post post)
        {
            if (ModelState.IsValid)
            {
